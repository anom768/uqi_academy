...
class ExperienceUpdateRequest {
    ...
    public function __construct(?int $id, ?string $id_student, ?string $type, ?string $company, ?string $entry_date, ?string $end_date, ?string $address, ?string $website, ?string $description)
    {
        $this->id = $id;
